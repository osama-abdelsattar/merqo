    ...
    <div className="-mx-6 sm:py-6 max-w-7xl sm:mx-auto min-h-[calc(100vh-5rem)] flex flex-col gap-4">
      <div className="grow flex justify-center items-center">
        <div className="w-full flex flex-col lg:flex-row gap-4">
          <div className="p-4 border bg-card sm:rounded-4xl shadow-lg h-fit lg:sticky lg:top-24 w-full lg:w-fit">
            <Skeleton className="lg:w-[calc(640px/2)] h-[calc(873px/2)]" />
          </div>
          <Card className="gap-4 w-full rounded-none sm:rounded-4xl">
            <CardHeader>
              <CardAction>
                <WishlistButton variant="outline" disabled productId="" />
              </CardAction>
